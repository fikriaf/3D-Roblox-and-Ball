...
for frame in range(num_frames):
    ...
    output1 = f"{nama_file}_Lapangan_edit-with-ball_cam1_{frame:03d}.jpg"
    plt.imsave(output1, screen1)
    
    # Camera 2: 180° back
    screen2 = project_with_camera_orbit(voxel_frame, cam2_angle, cam2_distance, focal_length, latar_pil)
    output2 = f"{nama_file}_Lapangan_edit-with-ball_cam2_{frame:03d}.jpg"
    plt.imsave(output2, screen2)

print("\nDone!")
print(f"Output: {nama_file}_Lapangan_edit-with-ball_cam1_000.jpg to {nama_file}_bg_cam1_019.jpg")
print(f"Output: {nama_file}_Lapangan_edit-with-ball_cam2_000.jpg to {nama_file}_bg_cam2_019.jpg")
